...
contract Token is owned {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        require(!frozenAccount[msg.sender]);                // Check if account is not frozen
    ...
    /**
    * Owner can create _mintedAmount of tokens and deliver it at _target address
    */
    ...
    /**
    * Owner can freeze target address
    */
